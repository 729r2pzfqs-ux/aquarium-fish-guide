...
with open(BASE_DIR / 'data' / 'translations_es.json', encoding='utf-8') as _f:
...
TRANSLATIONS = [
    ...
    (r'Neon Tetra', 'Tetra Neón'),
    (r'Cardinal Tetra', 'Tetra Cardenal'),
    (r'Rummy Nose Tetra', 'Tetra Nariz de Borracho'),
    (r'Ember Tetra', 'Tetra Brasa'),
    (r'Black Neon Tetra', 'Tetra Neón Negro'),
    (r'Glowlight Tetra', 'Tetra Luminoso'),
    (r'Lemon Tetra', 'Tetra Limón'),
    (r'Serpae Tetra', 'Tetra Serpa'),
    (r'Black Skirt Tetra', 'Tetra Falda Negra'),
    (r'Diamond Tetra', 'Tetra Diamante'),
    (r'Emperor Tetra', 'Tetra Emperador'),
    (r'Congo Tetra', 'Tetra del Congo'),
    (r'Bleeding Heart Tetra', 'Tetra Corazón Sangrante'),
    (r'X-Ray Tetra', 'Tetra Rayos X'),
    (r'Flame Tetra', 'Tetra Llama'),
    (r'Silvertip Tetra', 'Tetra Punta Plateada'),
    (r'Red Eye Tetra', 'Tetra Ojo Rojo'),
    (r'Black Phantom Tetra', 'Tetra Fantasma Negro'),
    (r'Penguin Tetra', 'Tetra Pingüino'),
    (r'Buenos Aires Tetra', 'Tetra Buenos Aires'),
    (r'>Guppy<', '>Guppy<'),
    (r'>Betta Fish<', '>Pez Betta<'),
    (r'>Betta<', '>Betta<'),
    (r'>Goldfish<', '>Pez Dorado<'),
    (r'>Angelfish<', '>Pez Ángel<'),
    (r'>Discus<', '>Disco<'),
    (r'>Oscar<', '>Óscar<'),
    (r'Corydoras Catfish', 'Corydoras'),
    (r'Bronze Cory', 'Corydoras Bronce'),
    (r'Panda Cory', 'Corydoras Panda'),
    (r'Peppered Cory', 'Corydoras Pimienta'),
    (r'Julii Cory', 'Corydoras Julii'),
    (r'Pygmy Cory', 'Corydoras Pigmeo'),
    (r'Sterbai Cory', 'Corydoras Sterbai'),
    (r'Cherry Barb', 'Barbo Cereza'),
    (r'Tiger Barb', 'Barbo Tigre'),
    (r'Rosy Barb', 'Barbo Rosado'),
    (r'Gold Barb', 'Barbo Dorado'),
    (r'Odessa Barb', 'Barbo Odessa'),
    (r'Denison Barb', 'Barbo Denison'),
    (r'Checker Barb', 'Barbo Ajedrez'),
    (r'Tinfoil Barb', 'Barbo Hoja de Lata'),
    (r'Zebra Danio', 'Danio Cebra'),
    (r'Pearl Danio', 'Danio Perla'),
    (r'Celestial Pearl Danio', 'Danio Perla Celestial'),
    (r'Leopard Danio', 'Danio Leopardo'),
    (r'Giant Danio', 'Danio Gigante'),
    (r'Longfin Zebra Danio', 'Danio Cebra Aleta Larga'),
    (r'Gold Ring Danio', 'Danio Anillo Dorado'),
    (r'Harlequin Rasbora', 'Rasbora Arlequín'),
    (r'Chili Rasbora', 'Rasbora Chile'),
    (r'Lambchop Rasbora', 'Rasbora Chuleta'),
    (r'Phoenix Rasbora', 'Rasbora Fénix'),
    (r'Scissortail Rasbora', 'Rasbora Cola de Tijera'),
    (r'Emerald Eye Rasbora', 'Rasbora Ojo Esmeralda'),
    (r'Dwarf Gourami', 'Gurami Enano'),
    (r'Pearl Gourami', 'Gurami Perla'),
    (r'Honey Gourami', 'Gurami Miel'),
    (r'Blue Gourami', 'Gurami Azul'),
    (r'Kissing Gourami', 'Gurami Besador'),
    (r'Moonlight Gourami', 'Gurami Luz de Luna'),
    (r'Sparkling Gourami', 'Gurami Brillante'),
    (r'>Molly<', '>Molly<'),
    (r'>Platy<', '>Platy<'),
    (r'>Swordtail<', '>Cola de Espada<'),
    (r'Sailfin Molly', 'Molly Vela'),
    (r'Balloon Molly', 'Molly Globo'),
    (r'Endler Livebearer', 'Endler'),
    (r'>Endler<', '>Endler<'),
    (r'Siamese Fighting Fish', 'Pez Luchador de Siam'),
    (r'Kuhli Loach', 'Locha Kuhli'),
    (r'Clown Loach', 'Locha Payaso'),
    (r'Yoyo Loach', 'Locha Yoyo'),
    (r'Hillstream Loach', 'Locha de Torrente'),
    (r'Dojo Loach', 'Locha Dojo'),
    (r'Zebra Loach', 'Locha Cebra'),
    (r'Dwarf Chain Loach', 'Locha Cadena Enana'),
    (r'>Otocinclus<', '>Otocinclus<'),
    (r'Amano Shrimp', 'Gamba Amano'),
    (r'Cherry Shrimp', 'Gamba Cereza'),
    (r'Ghost Shrimp', 'Gamba Fantasma'),
    (r'Blue Velvet Shrimp', 'Gamba Terciopelo Azul'),
    (r'Crystal Red Shrimp', 'Gamba Cristal Rojo'),
    (r'Bamboo Shrimp', 'Gamba Bambú'),
    (r'Nerite Snail', 'Caracol Nerita'),
    (r'Mystery Snail', 'Caracol Misterio'),
    (r'Assassin Snail', 'Caracol Asesino'),
    (r'Ramshorn Snail', 'Caracol Cuerno de Carnero'),
    (r'Malaysian Trumpet Snail', 'Caracol Trompeta Malayo'),
    (r'Rabbit Snail', 'Caracol Conejo'),
    (r'Ram Cichlid', 'Cíclido Ramirezi'),
    (r'German Blue Ram', 'Ramirezi Azul Alemán'),
    (r'Bolivian Ram', 'Ramirezi Boliviano'),
    (r'>Apistogramma<', '>Apistogramma<'),
    (r'Apistogramma Cacatuoides', 'Apistogramma Cacatúa'),
    (r'Apistogramma Borellii', 'Apistogramma Borellii'),
    (r'>Kribensis<', '>Kribensis<'),
    (r'Electric Blue Acara', 'Acara Azul Eléctrico'),
    (r'Firemouth Cichlid', 'Cíclido Boca de Fuego'),
    (r'Convict Cichlid', 'Cíclido Convicto'),
    (r'Jack Dempsey', 'Jack Dempsey'),
    (r'Green Terror', 'Terror Verde'),
    (r'>Flowerhorn<', '>Flowerhorn<'),
    (r'African Cichlid', 'Cíclido Africano'),
    (r'Yellow Lab', 'Labidochromis Amarillo'),
    (r'Peacock Cichlid', 'Cíclido Pavo Real'),
    (r'Jewel Cichlid', 'Cíclido Joya'),
    (r'>Severum<', '>Severum<'),
    (r'Rainbow Fish', 'Pez Arcoíris'),
    (r'Boesemani Rainbow', 'Arcoíris de Boeseman'),
    (r'Turquoise Rainbow', 'Arcoíris Turquesa'),
    (r'Neon Dwarf Rainbow', 'Arcoíris Enano Neón'),
    (r'Forktail Rainbow', 'Arcoíris Cola Bifurcada'),
    (r'Red Irian Rainbow', 'Arcoíris Rojo de Irian'),
    (r'Celebes Rainbow', 'Arcoíris de Célebes'),
    (r'Madagascar Rainbow', 'Arcoíris de Madagascar'),
    (r'Gertrudae Rainbow', 'Arcoíris Gertrudae'),
    (r'White Cloud Mountain Minnow', 'Neón Chino'),
    (r'Killifish', 'Killis'),
    (r'Clown Killifish', 'Killi Payaso'),
    (r'Golden Wonder Killifish', 'Killi Maravilla Dorada'),
    (r'Blue Notho', 'Notho Azul'),
    (r'Least Killifish', 'Killi Enano'),
    (r'Bristlenose Pleco', 'Pleco Nariz de Cerdas'),
    (r'Common Pleco', 'Pleco Común'),
    (r'Clown Pleco', 'Pleco Payaso'),
    (r'Rubber Lip Pleco', 'Pleco Labio de Goma'),
    (r'Royal Pleco', 'Pleco Real'),
    (r'Siamese Algae Eater', 'Comealgas Siamés'),
    (r'Flying Fox', 'Zorro Volador'),
    (r'Red Tailed Shark', 'Tiburón Cola Roja'),
    (r'Rainbow Shark', 'Tiburón Arcoíris'),
    (r'Bala Shark', 'Tiburón Bala'),
    (r'Glass Catfish', 'Pez Gato de Cristal'),
    (r'Pictus Catfish', 'Pez Gato Pictus'),
    (r'Upside Down Catfish', 'Pez Gato Invertido'),
    (r'Paradise Fish', 'Pez Paraíso'),
